...
public final class ItemEntity extends BasicEntity implements Serializable {
    ...
    public ObjectId getRefCategoryId() {
        return refCategoryId != null ? refCategoryId
                : (refCategory == null || refCategory.getId() == null
                ? null : new ObjectId(refCategory.getId().toHexString()));
    }
    ...
    public void setRefCategory(CategoryEntity refCategory) {
        ...
        this.refCategoryId = refCategory == null || refCategory.getId() == null
                ? null : new ObjectId(refCategory.getId().toHexString());
    }
