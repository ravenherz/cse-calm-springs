...
public final class ImageMetadata {
    ...
    public static Map<String, String> withDimensions(Map<String, String> existing, int width, int height) {
        if (width <= 0 || height <= 0) {
            return existing;
        }
        Map<String, String> fields = existing == null ? new LinkedHashMap<>() : new LinkedHashMap<>(existing);
