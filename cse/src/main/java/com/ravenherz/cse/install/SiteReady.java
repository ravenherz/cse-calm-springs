...
public class SiteReady {
    ...
    public SiteReady(DataProvider dataProvider, ServiceProvider serviceProvider) {
    ...
    public boolean isConfigured() {
        ...
        if (CseDisk.siteReadyMarkerPresent()) {
    ...
    static boolean secretFilesPresent() {
        File instance = CseDisk.secretFile(
                SettingKeys.CONTEXT_DATASOURCE_DBMS_INSTANCE + Strings.EXTENSION_JSON);
        File access = CseDisk.secretFile(
                SettingKeys.CONTEXT_DATASOURCE_DBMS_ACCESS + Strings.EXTENSION_JSON);
