...
import com.ravenherz.cse.install.InstallSettings;
import com.ravenherz.cse.transfer.SiteSettings;
...
public class Settings implements Serializable, ConfigSource, SettingsDocuments, SiteSettings, InstallSettings {
