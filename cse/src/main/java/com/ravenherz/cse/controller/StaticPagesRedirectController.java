...
/**
 * Legacy public URL. Packed apps now live under {@code /apps/**}.
 */
@Controller
@RequestMapping("/static-pages")
public class StaticPagesRedirectController {

    static final String OLD_PREFIX = "/static-pages";
    static final String NEW_PREFIX = "/apps";
    ...
    public void redirect(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String target = contextPath(request) + NEW_PREFIX + rest;
