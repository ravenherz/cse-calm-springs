...
import com.ravenherz.cse.admin.PlaylistDesk;
...
@Component
public class PlaylistAdapter implements PlaylistDesk {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlaylistAdapter.class);
    ...
    public PlaylistAdapter(AuthSupport authSupport, EditorChrome editorChrome, ServiceProvider serviceProvider,
    ...
    @Override
    public String create(String playlistId, String title, String description, List<String> resourceIds,
    ...
    @Override
    public String save(String id, String playlistId, String title, String description, List<String> resourceIds,
            List<String> titleOverrides, List<String> artistOverrides, String coverResourceId, Model model,
            HttpServletRequest request, HttpServletResponse response) throws IOException {
        AccountEntity accessor = authSupport.getAccessor(request, response);
        if (accessor == null) {
