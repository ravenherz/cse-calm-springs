...
import com.ravenherz.cse.admin.ThemeDesk;
...
@Component
public class ThemeAdapter implements ThemeDesk {
    ...
    private final ThemePackDeployer themePackDeployer;
    private final ThemeCatalog themeCatalog;
    private final ResourceGroupIndex resourceGroupIndex;

    public ThemeAdapter(AuthSupport authSupport, ServiceProvider serviceProvider, Settings settings,
            ThemePackDeployer themePackDeployer, ThemeCatalog themeCatalog, ResourceGroupIndex resourceGroupIndex) {
        this.authSupport = authSupport;
        this.serviceProvider = serviceProvider;
        this.settings = settings;
        this.themePackDeployer = themePackDeployer;
    ...
    @Override
    public String upload(MultipartFile file, String returnGroup, HttpServletRequest request,
    ...
    @Override
    public String activate(String themeId, String returnGroup, HttpServletRequest request,
            HttpServletResponse response) throws IOException {
        AccountEntity accessor = authSupport.getAccessor(request, response);
        if (accessor == null) {
            return null;
    ...
    @Override
    public String reorder(List<String> themeIds, String returnGroup, HttpServletRequest request,
            HttpServletResponse response) throws IOException {
        AccountEntity accessor = authSupport.getAccessor(request, response);
        if (accessor == null) {
            return null;
    ...
    @Override
    public String delete(String themeId, String returnGroup, HttpServletRequest request,
            HttpServletResponse response) throws IOException {
        AccountEntity accessor = authSupport.getAccessor(request, response);
        if (accessor == null) {
            return null;
